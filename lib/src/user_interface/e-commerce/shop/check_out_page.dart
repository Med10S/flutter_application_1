...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  void initState() {
    super.initState();
    userInformation();
    //paymentController2.updateTotalPrice(cartproducts);
  ...
  Widget build(BuildContext context) {
    ...
    Widget checkOutButton = InkWell(
      onTap: () async {
        ...
        if (location != null && cartproducts!.isNotEmpty) {
          soldeVerficarion =
              paymentController2.checkSolde(_userModel!.points!, cartproducts);
    ...
    Widget subTot = cartproducts != null
        ? Obx(() => Text(
      ...
      body: FutureBuilder<List<CartProduct>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            paymentController2.updateTotalPrice(cartproducts); // Appel ici
            return cartproducts!.isNotEmpty
                ...
                : Center(
                    ...
                    children: [
                      Image.asset('images/cart-empty.png'),
                      const Text(
                        'Your cart is empty',
